      ...
      <div className="flex flex-wrap justify-between">
        <div className="w-full md:w-8/12 px-4 mb-8">
          ...
          <h2 className="text-3xl font-bold mt-4 mb-2">
            Passionate About Teaching? Join Our Expert Community!
          </h2>
          <p className="text-gray-700 mb-4">
            Are you a seasoned professional eager to share your expertise and
            make a difference? Our platform is the perfect place for you to
            empower the next generation of learners while enhancing your own
            career.
          </p>
          ...
          <ul className="list-disc list-inside text-gray-700 mb-4">
            <li>
              ...
              with a global audience of aspiring professionals and make a
              lasting impact on their careers.
            </li>
            <li>
              <span className="font-semibold">Earn While You Teach:</span> Enjoy
              the flexibility of earning supplemental income on your terms, with
              opportunities to grow as you contribute.
            </li>
            <li>
              <span className="font-semibold">Collaborate with Peers:</span>{" "}
              Join a vibrant community of like-minded experts, sharing insights
              and experiences that enrich both teaching and learning.
            </li>
            <li>
              <span className="font-semibold">Shape the Future:</span> Play a
              crucial role in shaping the future workforce by imparting the
              skills and knowledge needed for tomorrow&apos;s challenges.
            </li>
          </ul>
        </div>
        <div className="w-full md:w-4/12 px-4 mb-8">
          <div className="bg-white shadow-[0_4px_12px_-4px_rgba(6,81,237,0.3)] rounded-lg overflow-hidden px-4 py-6">
            ...
            <p className="text-gray-500 text-sm mb-4">
              Submit your details below, and a representative will connect with
              you to assist with your onboarding. Together, we can build the
              future of learning!
            </p>
